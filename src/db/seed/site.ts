...
const result = await db.insert(site).values([
    ...
    { page:"mcp", section:  "header",property:"title",value:"Catálogo"},
    { page:"site", section: "header",property:"subtitle",value:"Medios de Pago"},
    { page:"site", section: "footer",property:"copyright",value:"© 2026 Catálogo"},
    { page:"site", section: "footer",property:"aviso",value:"Todos los precios están sujetos a cambios sin previo aviso"},
    { page:"site", section: "footer",property:"link_text",value:"Volver al Catálogo"},
    { page:"site", section: "footer",property:"link_url",value:"#!/"},
])